...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        ...
        self.account_id = os.environ.get("IDOMOO_ACCOUNT_ID") or ""
        # Password for HTTP basic authentication
        self.api_secret_key = os.environ.get("IDOMOO_API_SECRET_KEY") or ""

        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("idomoo")
    ...
    def get_basic_auth_token(self):
        ...
        return urllib3.util.make_headers(
            basic_auth=self.account_id + ':' + self.api_secret_key
        ).get('authorization')
