...
class Soundtrack(object):
    ...
    def val(self):
        ...
        Path to the audio file of your soundtrack.  Use a path to external files or files held on Idomoo servers. More about paths can be found [here](https://academy.idomoo.com/support/solutions/articles/4000068850).  Preferably a wav or mp3 file.
