...
class TextProperties(object):
    ...
    def __init__(self, text=None, color=None, font_path=None, scale=None, baseline=None, highlight=None, strikethrough=None, underline=None):
    ...
    def color(self):
        ...
        Overwrite the color for this part of the text.  Use this syntax: `\"rgb(###, ###, ###)\"`. Use 8bit color ranging from `0-255`.
    ...
    def color(self, color):
        ...
        :type: str
        """
        if color is not None and not re.search('^rgb\\((\\d{1,3}), (\\d{1,3}), (\\d{1,3})\\)', color):
            raise ValueError("Invalid value for `color`, must be a follow pattern or equal to `/^rgb\\((\\d{1,3}), (\\d{1,3}), (\\d{1,3})\\)/`")
    ...
    def font_path(self, font_path):
        ...
        :type: str
        """
        if font_path is not None and not re.search('^(http|ual|pal)', font_path):
            raise ValueError("Invalid value for `font_path`, must be a follow pattern or equal to `/^(http|ual|pal)/`")
    ...
    def highlight(self):
        ...
        Draw a colored box behind the text similar to a word processor highlight. Not passing this parameter means no highlight.  Enter the color you want. Use this syntax: `\"rgb(###, ###, ###)\"`. Use 8bit color ranging from `0-255`.
    ...
    def highlight(self, highlight):
        ...
        :type: str
        """
        if highlight is not None and not re.search('^rgb\\((\\d{1,3}), (\\d{1,3}), (\\d{1,3})\\)', highlight):
            raise ValueError("Invalid value for `highlight`, must be a follow pattern or equal to `/^rgb\\((\\d{1,3}), (\\d{1,3}), (\\d{1,3})\\)/`")
