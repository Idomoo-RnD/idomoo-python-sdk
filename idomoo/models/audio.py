...
class Audio(object):
    ...
    def __init__(self, key=None, val=None, start_time=None, start_referrer=None, mute=False, fade_start=None,
                 fade_end=None, volume=None, sidechain_compression_affect=False, duration_referrer=False,
                 duration_addition=None):
    ...
    def val(self):
        ...
        The path to the audio file. Use a path to external files or files held on Idomoo servers. More about paths
        can be found [here](https://academy.idomoo.com/support/solutions/articles/4000068850).  Use a wav or mp3 file.
    ...
    def start_time(self):
        ...
        The start time of the audio in seconds. Scene start is 0. Default for placeholders generated in After Effects
        is the time in After Effects. For placeholders generated on the call, default is 0.  If `\"start_referrer\"`
        is used this parameter turns to an offset parameter. By how much to offset the start of this placeholder from
        the end of another placeholder.
    ...
    def start_referrer(self):
        ...
        Instead of using `\"start_time\"` the placeholder can start when another placeholder finishes. Write the
        `\"key\"` of this other placeholder here.
    ...
    def sidechain_compression_affect(self):
        ...
        placeholder that have `\"sidechain_compression_affect\":true` will affect the soundtrack's volume. True means
        this placeholder is one.
    ...
    def duration_referrer(self):
        ...
        This placeholder defines the duration of the scene. Only a single placeholder in a scene can use this. When
        the media of this placeholder is over + the `\"duration_addition\"` is over, the scene ends.
